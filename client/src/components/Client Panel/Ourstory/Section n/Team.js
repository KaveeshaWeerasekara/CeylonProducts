...
function Team() {
    return (
        <div>
            <div className="container flex justify-center mx-auto pt-1">
                <div>
                    <p className="text-gray-500 text-lg text-center font-bold pb-3">OUR TEAM</p>
                    <h1 className="xl:text-4xl text-3xl text-center text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">The Talented People Behind the Scenes of the Project</h1>
                </div>
            </div>
                    ...
                    <div className="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                            ...
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src="https://img.freepik.com/free-photo/profile-shot-stylish-cool-attractive-curly-haired-european-25s-woman-red-dress-turning-camera-smiling-broadly-with-delighted-carefree-expression-having-fun-yellow-background_1258-81974.jpg?w=2000" alt className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Imasha Gunasekara</div>
                                    <p className="text-gray-800 text-sm text-center">Chief Executive Officer</p>
                                    <p className="text-center text-gray-600 text-base pt-3 font-normal">The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration.rat sharing and collaboration.</p>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src="https://img.freepik.com/free-photo/cheerful-optimsitic-young-female-student-with-curly-dark-hairstyle-yellow-sweater-smiling-laughing-happily-pointing-fingers-up-showing-friends-link-site-copy-space-white-wall_176420-35073.jpg?w=2000" alt className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Wishmi Kaveeshsa</div>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Suneth Madhuwantha</div>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32  sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Kavindu Chinthaka</div>
                                    <p className="text-gray-800 text-sm text-center">Principal Software Engineer</p>
                                    <p className="text-center text-gray-600 text-base pt-3 font-normal">An avid open-source developer who loves to be creative and inventive. I have 20 years of experience in the field.asjaring the alyheh  ring and collaboration.</p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
                                        <a href="javascript:void(0)" className="mx-5">
                                            <div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-github">
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32  sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src="https://media.istockphoto.com/photos/portrait-of-her-she-nice-cute-lovely-charming-attractive-cheerful-picture-id1132762987?k=20&m=1132762987&s=170667a&w=0&h=_SjezN4XVDnF8l5u-x08ZgI9A20vF4Tur4RQKgbtxZ8=" alt className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Tharuka Rathnayake</div>
                                    <p className="text-gray-800 text-sm text-center">Product Design Head</p>
