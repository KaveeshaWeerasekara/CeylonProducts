...
const deleteListingsData = async (id) => {
  ...
  <Typography className={classes.titleColor} variant="h6" component="h2" >{listings.title}</Typography>
   ...
   <Typography className={classes.titleColor} align= 'center' variant="h5" component="h2">{listings.title}</Typography>
   
     <Typography className={classes.titleColor} align='center'variant="body2" color="textSecondary" component="p">{listings.description}</Typography>
     
     <Typography className={classes.titleColor2} align='center' variant="subtitile1"  component="p">{listings.price}</Typography>
      ...
      <CardActions className={classes.cardActions}>
        ...
        <Link to ={"/Form"}><Button variant="contained" size="small" color="primary" > <EditIcon fontSize="small" />Edit</Button></Link>
